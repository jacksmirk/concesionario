...
class TipoMotorController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['TipoMotor'];
			if($model->save())
...
/*		$dataProvider=new CActiveDataProvider('TipoMotor');
	...
	{
		$model=new TipoMotor('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['TipoMotor']))
			$model->attributes=$_GET['TipoMotor'];
	...
	{
		$model=TipoMotor::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tipo-motor-form')
		{
