...
/**
 * This is the model class for table "tbl_encargados".
 *
 * The followings are the available columns in table 'tbl_encargados':
...
class Encargado extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('userid, nombre, fecha_alta, fecha_mod', 'safe', 'on'=>'search'),
		);
	}
