...
/**
 * This is the model class for table "tbl_coches".
 *
 * The followings are the available columns in table 'tbl_coches':
 * @property string $vehiculoid
 * @property integer $num_puertas
 *
...
class Coche extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('num_puertas', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('vehiculoid, num_puertas', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('num_puertas',$this->num_puertas);
